...
use App\Actions\Socialstream\GenerateRedirectForProvider as SocialstreamGenerateRedirectForProvider;
...
class SocialstreamServiceProvider extends ServiceProvider {
    ...
    public function boot() {
        ...
        Socialstream::generatesProvidersRedirectsUsing(SocialstreamGenerateRedirectForProvider::class);
    }
}
