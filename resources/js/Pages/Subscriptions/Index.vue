                        ...
                        <tr class="text-xs"
                            ...
                            <td class="font-medium">
                                <jet-dropdown align="right" width="48">
                                    <template #trigger>
                                        <button type="button" class="inline-flex items-center px-3 py-2 text-xs border border-gray-200 leading-4 font-medium rounded-md text-gray-500 bg-white hover:bg-gray-50 hover:text-gray-700 focus:outline-none focus:bg-gray-50 active:bg-gray-50 transition">
                                            Actions
                                        </button>
                                    </template>
                                    <template #content>
                                        <div class="">
                                            <jet-dropdown-link
                                                :href="route('kinja.subscriptions.show', subscription.id)">
                                                Show
                                            </jet-dropdown-link>
                                        </div>
                                    </template>
