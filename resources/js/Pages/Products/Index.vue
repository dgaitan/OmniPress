            ...
            <section class="pb-8">
              <div class="container px-4 mx-auto">
                <div class="p-4 mb-6 bg-white shadow rounded overflow-x-auto">
                  ...
                  <div class="mb-5">
                    <a class="inline-block px-4 pb-2 text-sm font-medium text-indigo-500 border-b-2 border-indigo-500" href="#">Publish</a>
                    <a class="inline-block px-4 pb-2 text-sm font-medium text-gray-500 border-b-2 border-transparent" href="#">Draft</a>
                  </div>
                  
                  <table class="table-fixed w-full">
                    <thead class="bg-gray-100">
                      <tr class="text-xs text-gray-500 text-left">
                        <th class=" items-center pl-6 py-4 font-medium" width="300px">
                          <span>Information</span>
                        </th>
                        <th class="py-4 pr-12 font-medium" width="100px">
                          Status
                        </th>
                        <th class="py-4 pr-12 font-medium" width="100px">
                          Price
                        </th>
                        <th class="py-4 pr-12 font-medium" width="150px">
                          Date Created
                        </th>
                    ...
                    <tbody>
                      <tr class="border-b border-blue-50 align-top" v-for="product in products" :key="product.id">
                        <td class="py-3 px-6 font-medium" width="300px">
                          <div class="flex">
                            <img v-if="product.images.length === 0" class="w-20 h-20 mr-4 object-cover rounded-md" src="https://images.unsplash.com/photo-1559893088-c0787ebfc084?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;ixlib=rb-1.2.1&amp;auto=format&amp;fit=crop&amp;w=1050&amp;q=80" alt="">
