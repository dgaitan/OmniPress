                  ...
                  <table class="table-auto w-full">
                    <thead>
                      <tr class="text-xs text-gray-500 text-left">
                        <th class="pl-6 pb-3 font-medium">Coupon ID</th>
                        <th class="pl-6 pb-3 font-medium">Code</th>
                        <th class="pb-3 font-medium">Created At</th>
                        <th class="pb-3 font-medium">Discount Type</th>
                        <th class="pb-3 font-medium">Amount</th>
                        <th class="pb-3 font-medium">Purchased</th>
                        <th class="pb-3 font-medium">Action</th></tr>
                    </thead>
                    <tbody>
                        <tr class="text-xs bg-gray-50" v-for="coupon in coupons.data">
                            <td class="py-5 px-6 font-medium">#{{ coupon.coupon_id }}</td>
                            <td class="py-5 px-6 font-medium">{{ coupon.code }}</td>
                            <td class="flex px-4 py-3">
                                {{ coupon.created_at }}
                            </td>
                            <td class="font-medium">{{ coupon.discount_type }}</td>
                            <td>
